...
namespace DataAccess
{
    ...
    {
        //数据库连接字符串
        public static readonly string conn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + System.Configuration.ConfigurationManager.ConnectionStrings["sqlite"].ConnectionString;
